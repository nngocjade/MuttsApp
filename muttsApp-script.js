...
function getUserChats() {
  fetch("http://localhost:8080/muttsApp.html")
    ...
    .then(dataObj => createMessagePreviewBox(dataObj));
}
...
function createMessagePreviewBox(chatObj) {
  ...
  MessagePreviewBox.setAttribute("data-chat_id", chatObj.sender_id);
  MessagePreviewBox.addEventListener("click", previewBoxClick);

  let imgWrap = document.createElement("div");
  imgWrap.setAttribute("data-chat_id", chatObj.sender_id);
  imgWrap.classList.add("img-wrap");
  let image = document.createElement("img");
  image.setAttribute("data-chat_id", chatObj.sender_id);
  ...
  textWrap.setAttribute("data-chat_id", chatObj.sender_id);
  textWrap.classList.add("message-text-wrap");
  let nameParagraph = document.createElement("p");
  nameParagraph.setAttribute("chat-chat_id", chatObj.sender_id);
  nameParagraph.innerText = chatObj.chat_name;
  let messageParagraph = document.createElement("p");
  messageParagraph.setAttribute("chat-chat_id", chatObj.sender_id);
  ...
  dateWrap.setAttribute("data-chat_id", chatObj.sender_id);
  dateWrap.classList.add("date-wrap");
  let dateP = document.createElement("p");
  dateP.setAttribute("data-chat_id", chatObj.sender_id);
